...
*/
  ...
  function(e, t, n) {
    ...
    function Ne(e) {
      Ee ? (je ? je.push(e) : (je = [e])) : (Ee = e);
    }
    function Re() {
      if (Ee) {
        var e = Ee,
          t = je;
        if (((je = Ee = null), Me(e), t))
    ...
    var At = !1;
    function Ft() {
      Et && (Et.detachEvent("onpropertychange", It), (jt = Et = null));
    }
    function It(e) {
      "value" === e.propertyName && Nt(jt) && Ue(Mt, (e = Ot(jt, e, We(e))));
    }
    function zt(e, t, n) {
      "focus" === e
        ? (Ft(), (jt = n), (Et = t).attachEvent("onpropertychange", It))
        : "blur" === e && Ft();
    }
    function Ut(e) {
    ...
    function zo(e, t, n, r) {
      ...
      "object" == typeof i && null !== i
        ...
        : ((i = Mr(t) ? Er : Cr.current), (o.context = jr(e, i))),
    ...
    function Wo(e) {
      ...
      function s(e, t, n, r) {
        return null !== t && t.elementType === n.type
          ...
          : (((r = Br(n.type, n.key, n.props, null, e.mode, r)).ref = Do(
              e,
              t,
              n
            )),
      ...
      function d(e, t, n) {
        ...
        if ("object" == typeof t && null !== t) {
          switch (t.$$typeof) {
            case Qe:
              return (
                ((n = Br(t.type, t.key, t.props, null, e.mode, n)).ref = Do(
                  e,
                  null,
                  t
                )),
    ...
    function Bi(e, t, n) {
      ...
      if (((Ni = !1), (mo = yo = ho = Ei.currentDispatcher = null), o))
    ...
    function ja(e, t, n) {
      ...
      for (
        yr = { focusedElem: d, selectionRange: E }, Pn = !1, Ui = f;
        null !== Ui;
      ...
      (Ni = Di = !1), "function" == typeof Ur && Ur(t.stateNode);
      var Ue = t.expirationTime,
        De = t.childExpirationTime,
        Le = 0 === Ue || (0 !== De && De < Ue) ? De : Ue;
  ...
  function(e, t, n) {
    ...
    if ("undefined" != typeof window && window._schedMock) {
      ...
      (v = function(e, t) {
        (M = e),
          (R = t),
          F || 0 > t ? window.postMessage(D, "*") : A || ((A = !0), T(L));
      }),
        (g = function() {
          (M = null), (N = !1), (R = -1);
        });
  ...
  function(e, t, n) {
    ...
    var N = function() {
      return {
        plugins: [
          ...
          T()(),
          C()(),
          "undefined" == typeof window ? null : E()(),
          M()()
        ]
      };
    };
    ...
    var J = {
        ...
        background: { paper: H.white, default: $[50] },
        action: {
      ...
      Z = {
        ...
        background: { paper: $[800], default: "#303030" },
        action: {
          active: H.white,
    ...
    function te(e) {
      var t = e.primary,
        ...
        i = e.error,
        a = void 0 === i ? { light: B[300], main: B[500], dark: B[700] } : i,
        l = e.type,
        s = void 0 === l ? "light" : l,
    ...
    var re = { textTransform: "uppercase" },
        ...
        create: function() {
          var e =
            ...
            t =
              arguments.length > 1 && void 0 !== arguments[1]
                ...
                : {},
            n = t.duration,
            r = void 0 === n ? pe.standard : n,
            o = t.easing,
            i = void 0 === o ? de.easeInOut : o,
            a = t.delay,
            l = void 0 === a ? 0 : a;
          ...
          return (Array.isArray(e) ? e : [e])
            .map(function(e) {
              return ""
                .concat(e, " ")
                .concat("string" == typeof r ? r : he(r), " ")
                .concat(i, " ")
                .concat("string" == typeof l ? l : he(l));
            })
            .join(",");
        },
    ...
    var ve = function() {
          ...
          function f(e, t) {
            ...
            return r === D.length
              ...
              : "@media (min-width:".concat(n[e]).concat(o, ") and ") +
                  "(max-width:".concat(n[D[r]] - a / 100).concat(o, ")");
          }
          return c()(
            {
              keys: D,
      ...
      return c()(
            ...
            return c()(
              {
                ...
                L(r, "".concat(e.up("xs"), " and (orientation: landscape)"), {
                  minHeight: 48
                }),
                L(r, e.up("sm"), { minHeight: 64 }),
                r)
              },
              n
            );
            ...
            var n = "function" == typeof t ? t(e) : t,
              ...
              S = function(t, n, r, i, a) {
                return c()(
                  ...
                  o === oe ? { letterSpacing: "".concat(ne(i / n), "em") } : {},
                  a,
                  x
                );
              },
              T = {
                ...
                buttonNext: S(h, 14, 1.5, 0.4, re),
                captionNext: S(d, 12, 1.66, 0.4),
                overline: S(d, 12, 2.66, 1, re)
              },
              P = {
                display4: c()(
                  {
                    ...
                    fontFamily: o,
                    letterSpacing: "-.04em",
                    lineHeight: "".concat(ne(128 / 112), "em"),
                    marginLeft: "-.04em",
                ...
                headline: c()(
                  {
                    ...
                    fontWeight: d,
                    fontFamily: o,
                    lineHeight: "".concat(ne(32.5 / 24), "em"),
                    color: e.text.primary
                  },
                  x
                ),
                title: c()(
                  {
                    ...
                    fontWeight: h,
                    fontFamily: o,
                    lineHeight: "".concat(ne(24.5 / 21), "em"),
                    color: e.text.primary
                  },
                  x
                ),
                ...
                body1: c()(
                  {
                    ...
                    fontWeight: d,
                    fontFamily: o,
                    lineHeight: "".concat(ne(20.5 / 14), "em"),
                    color: e.text.primary
                  },
                  x
                ),
        ...
        I()({ shape: ce, spacing: g, transitions: ye, zIndex: me }, h, {
    ...
    var ge = "__THEMING__",
      be = {
        ...
        initial: function(e) {
          return e[ge] ? e[ge].getState() : null;
        },
        subscribe: function(e, t) {
          return e[ge] ? e[ge].subscribe(t) : null;
        },
    ...
    var Me = Object(g.create)(N()),
      Ne = (function() {
        ...
        return function(e, t) {
          return (
            (l += 1),
            n && t && t.options.name
              ? "".concat(ke(t.options.name), "-").concat(e.key)
              : ""
                  .concat(o)
                  .concat(a)
                  .concat(l)
      ...
      Ae = new Map(),
      Fe = {},
      Ie = ve({ typography: { suppressWarning: !0 } });
        ...
        (v.ponyfillGlobal.__MUI_STYLES__.withStyles = function(e) {
          ...
          return function(n) {
            var r,
              ...
              s = void 0 === l ? null : l,
              f = t.name,
              p = u()(t, ["withTheme", "flip", "name"]),
              h = _e(e),
              y = h.themingEnabled || "string" == typeof f || a;
            (Re += 1), (h.options.index = Re);
            var v = (function(e) {
              function t(e, n) {
                var r;
                !(function(e, t) {
                  ...
                  ((r = Oe(this, Ee(t).call(this, e, n))).jss = n[b.jss] || Me),
                  (r.sheetsManager = Ae),
                ...
                return (
                  ...
                  (r.stylesCreatorSaved = h),
                  (r.sheetOptions = c()(
                    { generateClassName: Ne },
                    n[b.sheetOptions]
                  )),
                  (r.theme = y ? be.initial(n) || Ie : Fe),
                  r.attach(r.theme),
                  (r.cacheClasses = {
                    value: null,
                    lastProp: null,
                ...
                (function(e, t, n) {
                ...
                })(t, [
                  {
                    ...
                    value: function() {
                      var e = this;
                      y &&
                        (this.unsubscribeId = be.subscribe(
                          this.context,
                          function(t) {
                            var n = e.theme;
                            (e.theme = t),
                    ...
                    value: function(e) {
                      if (!this.disableStylesGeneration) {
                        var t = this.stylesCreatorSaved,
                          n = A.get(this.sheetsManager, t, e);
                        if (
                          (n ||
                            ((n = { refs: 0, sheet: null }),
                          ...
                          var r;
                          this.sheetsCache &&
                            (r = A.get(this.sheetsCache, t, e)),
                            r ||
                              ((r = this.createSheet(e)).attach(),
                              this.sheetsCache &&
                                A.set(this.sheetsCache, t, e, r)),
                            (n.sheet = r);
                  ...
                  },
                  {
                    key: "createSheet",
                    value: function(e) {
                      var t = this.stylesCreatorSaved.create(e, f),
                        r = f;
                        ...
                        c()(
                          {
                            ...
                            classNamePrefix: r,
                            flip:
                              "boolean" == typeof s ? s : "rtl" === e.direction,
                            link: !1
                          },
                          this.sheetOptions,
                    ...
                    value: function(e) {
                      if (!this.disableStylesGeneration) {
                        ...
                        if (((t.refs -= 1), 0 === t.refs)) {
                          ...
                          var n = this.context[b.sheetsRegistry];
                          n && n.remove(t.sheet);
                        }
                      }
                    }
                  },
                  {
                    ...
                    value: function() {
                      var e = this.props,
                        t = e.innerRef,
                        r = u()(e, ["classes", "innerRef"]),
                        i = Se({ theme: this.theme, name: f, props: r });
                      return (
                        a && !i.theme && (i.theme = this.theme),
                        o.a.createElement(
                          n,
                          c()({}, i, { classes: this.getClasses(), ref: t })
                        )
                      );
                    }
                  }
            ...
            return (
              ...
              (v.contextTypes = c()(
                (Pe(
                  (r = { muiThemeProviderOptions: d.a.object }),
                  b.jss,
                  d.a.object
                ),
                Pe(r, b.sheetOptions, d.a.object),
                Pe(r, b.sheetsRegistry, d.a.object),
                r),
                y ? be.contextTypes : {}
              )),
              m()(v, n),
    ...
    (ze.propTypes = {}),
      (ze.defaultProps = { component: "div", elevation: 2, square: !1 });
    var Ue = (function(e, t) {
    ...
    a.a.render(
      o.a.createElement(Ue, null, "Hello, World!"),
