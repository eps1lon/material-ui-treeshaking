...
*/ var r =
  ...
  function(e, t, n) {
    ...
    var At = !1;
    function It() {
      Et && (Et.detachEvent("onpropertychange", Ft), (jt = Et = null));
    }
    function Ft(e) {
    ...
    function zt(e, t, n) {
      "focus" === e
        ? (It(), (jt = n), (Et = t).attachEvent("onpropertychange", Ft))
        : "blur" === e && It();
    }
    function Ut(e) {
            ...
            case Qe:
              e: {
                for (c = i.key, s = r; null !== s; ) {
                  if (s.key === c) {
                    if (
                      7 === s.tag ? i.type === Je : s.elementType === i.type
                    ) {
                      n(e, s.sibling),
                        ((r = o(
                          s,
    ...
    function Wi() {
      ...
      (Ai = null), (Ii = 0), (Fi = -1), (zi = !1), (Ri = null);
    }
    function Vi(e) {
      for (;;) {
        var t = e.alternate,
              ...
              if (null !== i && null != t.stateNode)
                ...
                if (Jo(t)) {
                  ...
                  var f = l.type,
                    d = l.memoizedProps,
                    p = u;
                  switch (((i[I] = l), (i[F] = d), (s = void 0), (u = f))) {
                    case "iframe":
                    case "object":
                      Cn("load", i);
                      break;
                    ...
                    case "select":
                      ...
                      break;
                    case "textarea":
                      Jn(i, d), Cn("invalid", i), dr(p, "onChange");
                  }
    ...
    function Gi(e, t, n, r) {
      ...
      if (0 !== o && r >= o && r <= i) {
        ...
        (0 === a || a < i) && (e.latestPingedTime = i), Xr(i, e);
    ...
    function Sa(e, t) {
      if (null === e.nextScheduledRoot)
        (e.expirationTime = t),
          null === Xi
            ? ((Ji = Xi = e), (e.nextScheduledRoot = e))
            : ((Xi = Xi.nextScheduledRoot = e).nextScheduledRoot = Ji);
      else {
    ...
    function Ta() {
      var e = 0,
        t = null;
      if (null !== Xi)
        for (var n = Xi, r = Ji; null !== r; ) {
          var o = r.expirationTime;
          if (0 === o) {
            if (
              ((null === n || null === Xi) && a("244"),
              r === r.nextScheduledRoot)
            ) {
              Ji = Xi = r.nextScheduledRoot = null;
              break;
            }
            if (r === Ji)
              ...
              if (r === Xi) {
                ((Xi = n).nextScheduledRoot = Ji), (r.nextScheduledRoot = null);
                break;
              }
    ...
    function ja(e, t, n) {
      ...
      if ((Xr(0, e), (Ei.current = null), 1 < t.effectTag))
                  ...
                  case 1:
                    if (256 & R.effectTag && null !== N) {
                      var A = N.memoizedProps,
                        I = N.memoizedState,
                        F = R.stateNode;
                      (F.props = R.memoizedProps), (F.state = R.memoizedState);
                      var z = F.getSnapshotBeforeUpdate(A, I);
      ...
      if (
        ...
        if (null !== q && Dn(G)) {
          var Q = q.start,
            Y = q.end;
          if ((void 0 === Y && (Y = Q), "selectionStart" in G))
            (G.selectionStart = Q),
              (G.selectionEnd = Math.min(Y, G.value.length));
          else {
            var J = G.ownerDocument || document,
              X = ((J && J.defaultView) || window).getSelection(),
            ...
            if (
              ...
              oe &&
              (1 !== X.rangeCount ||
                X.anchorNode !== re.node ||
                X.anchorOffset !== re.offset ||
                X.focusNode !== oe.node ||
                X.focusOffset !== oe.offset)
            ) {
              var ie = J.createRange();
              ie.setStart(re.node, re.offset),
                X.removeAllRanges(),
                ee > te
                  ? (X.addRange(ie), X.extend(oe.node, oe.offset))
                  : (ie.setEnd(oe.node, oe.offset), X.addRange(ie));
            }
          }
        }
          ...
          for (; null !== Ui; ) {
            ...
            if (128 & de) {
              ...
              if (null !== Ae) {
                ...
                "function" == typeof Ae ? Ae(Fe) : (Ae.current = Fe);
              }
            }
  ...
  function(e, t, n) {
    ...
    function h(e) {
      var t,
        ...
        S = h || (g ? "p" : v[w] || p[w]) || "span";
      return l.default.createElement(S, (0, o.default)({ className: _ }, k));
    }
    (h.propTypes = {}),
      (h.defaultProps = {
        align: "inherit",
        ...
        (y.ponyfillGlobal.__MUI_STYLES__.withStyles = function(e) {
          ...
          return function(n) {
            var r,
              ...
              R = (0, S.default)(e),
              A = R.themingEnabled || "string" == typeof _ || v;
